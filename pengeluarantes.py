...
class Ui_Pengeluaran(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.addItem("Makan")
        self.comboBox.addItem("Transportasi")
        self.comboBox.addItem("Belanja")
    ...
    def inputPengeluaran(self):
        ...
        print("Clicked")
        textcombo=str(self.comboBox.currentText())
        print(textcombo)
        ...
        a=konek.cursor()
        a.execute("UPDATE PENGELUARAN SET Jumlah_Pengeluaran=(?) WHERE _rowid_='1'",[Pengeluaran])
        konek.commit()
        a.execute("INSERT INTO CATEGORY VALUES(?)",[textcombo])
        konek.commit()
        konek.close()
